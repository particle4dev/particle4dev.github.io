        ...
        >
          ...
          <Collapse in={fiftyline50State} timeout="auto" unmountOnExit>
            ...
            >
              ...
              is the easy-to-use cryptocurrency portfolio management platform.
              We provide the service that help you to keep track of all your
          ...
          <Collapse in={komodoState} timeout="auto" unmountOnExit>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  Dice Application: An instant exchange built on top of
                  BarterDEX swap. It is inspired by Changelly and ShapeShift.
                </li>
                <li>
                  Atomicdex Application: This is a virtual dice app for Dice
                  Smart Contracts.
                </li>
              </ul>
            </Typography>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      Use Troposphere, Ansible to create and run infrastructure
                      on AWS
                    </li>
          ...
          <Collapse in={citymeState} timeout="auto" unmountOnExit>
            ...
            >
              ...
              <ul>
                ...
                <li>
                  Setup deployment pipeline for Production environment, work
                  with many modern technologies like Jenkins, AWS (EC2, ELB),
                  Docker ...
                </li>
              </ul>
            </Typography>
